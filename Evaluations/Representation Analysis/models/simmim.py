...
class ViTLayer(nn.Module):
    ...
    def forward(
        ...
        pre_attn = torch.clone(self.layernorm_before(hidden_states))                 # embeddings before attn
        ...
        outputs = (pre_attn, attention_output)  # add self attentions if we output attention weights
