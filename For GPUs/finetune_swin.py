...
# eval helper
from utils.eval_helpers import ClassificationModelSwin as ClassificationModel
...
EMBED_DIM          = parameters['embed_dim']                                  # patch size         
DEPTHS             = parameters['depths']
NUM_HEADS          = parameters['num_heads']
WINDOW_SIZE        = parameters['window_size']
DROP_PATH_RATE     = parameters['drop_path_rate']
MODEL_PATCH_SIZE   = parameters['model_patch_size']                           # model patch size to conform with VIT specs
...
backbone = transformers.SwinForMaskedImageModeling(config)
